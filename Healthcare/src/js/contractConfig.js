...
const contractABI = [
	...
	{
		"inputs": [],
		"name": "get_pending_doctor_approvals",
		"outputs": [
			{
				"internalType": "address[]",
				"name": "",
	...
	{
		"inputs": [],
		"name": "get_pending_patient_approvals",
		"outputs": [
			{
				"internalType": "address[]",
				"name": "",
...
const contractAddress = '0xe3B19608D811598082BeACF0dA670EbF9DD9f4fd'; // Your contract address
